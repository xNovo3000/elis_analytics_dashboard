...
class Gender {
  ...
  // instances
  static const Gender male = Gender._(singular: 'Uomo', plural: 'Uomini', technicalName: 'M', color: Color(0xFF2196F3));
  static const Gender female = Gender._(singular: 'Donna', plural: 'Donne', technicalName: 'F', color: Color(0xFFE91E63));
